...
function onProxyResponse(proxy, proxyReq, proxyRes, req, res) {
  ...
  if (statusCode === 200 && requestState.contentTypeWhitelist.length > 0) {
    if (!contentType || requestState.contentTypeWhitelist.indexOf(contentType) < 0) {
...
function getHandler(options, proxy) {
  var corsAnywhere = {
    ...
    contentTypeWhitelist: [],       // If non-empty, requests not of the specified Content-Types will be blocked.
  ...
  return function(req, res) {
    req.corsAnywhereRequestState = {
      ...
      contentTypeWhitelist: corsAnywhere.contentTypeWhitelist
    };
